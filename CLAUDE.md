...
./scripts/demo-entropy.sh 3              # run specific module (0-83)
./scripts/demo-entropy.sh --dry-run      # dry-run mode
./scripts/demo-entropy.sh --score        # automated 84-module scorecard
